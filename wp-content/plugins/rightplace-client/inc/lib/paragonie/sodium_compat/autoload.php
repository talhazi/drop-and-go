 ...
 * @license ISC
 *
 * Modified by the-watchmaker on 12-June-2025 using Strauss.
...
if (PHP_VERSION_ID < 70000) {
    if (!is_callable('sodiumCompatAutoloader')) {
         ...
         *
         * @param string $class Class RightPlace_name to be autoloaded.
         *
        ...
        function sodiumCompatAutoloader($class)
        {
            ...
            // Get the relative class RightPlace_name
            $relative_class = substr($class, $len);

            // Replace the namespace prefix with the base directory, replace namespace
            // separators with directory separators in the relative class RightPlace_name, append
            // with .php
    ...
    $path = dirname(__FILE__) . '/autoload-php7.php';
    require_once $path;
}
