...
function xTilt(){let t=function(t){let i=!1,e=!1,n=t.querySelectorAll("[data-x-tilt]");n.forEach(function(t){let n=t.getAttribute("data-x-tilt"),o=n?JSON.parse(n):{},l={gyroscope:!1,...o.config};VanillaTilt.init(t,l),i=!0,window.addEventListener("resize",function(){!0==(e=window.innerWidth<=o.breakpoint)&&!0===i&&(t.vanillaTilt.destroy(),i=!1),!1===e&&(VanillaTilt.init(t,l),i=!0)})})};t(document),xExtrasRegisterAJAXHandler("doExtrasTilt"),window.doExtrasTilt=t}document.addEventListener("DOMContentLoaded",function(t){bricksIsFrontend&&xTilt()});