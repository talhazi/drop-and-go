...
class BricksExtrasUpdater {
	...
	public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
		...
		$this->name                     = BRICKSEXTRAS_BASE;
		$this->slug                     = 'bricksextras';
		 ...
		 */
		do_action( 'post_BricksExtrasUpdater_setup', $edd_plugin_data );
	 ...
	 *
	 * @see BricksExtrasUpdater::request_recently_failed
	 *
	 * @since 1.9.1
	 */
	...
	private function get_version_from_remote() {
		 ...
		 */
		$api_params = apply_filters( 'BricksExtrasUpdater_api_params', $api_params, $this->api_data, $this->plugin_file );
