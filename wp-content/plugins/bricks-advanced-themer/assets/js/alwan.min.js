...
document.addEventListener("mousedown", function (event) {
    let t = event.target;
    if (!colorPickerComp.pickerOpen) return;

    const insidePopup = !!t.closest("#color_picker");
    if(!insidePopup){
        closePicker();
    }
}),
    ...
    (colorPickerComp.opacitySliderHandler = function (t) {
        ...
        (c = Number(Math.round(c + "e2") + "e-2")), (colorPickerComp.alpha = c), colorPickerComp.updateColorValueInput(), colorPickerComp.instance.element.setAttribute("data-color", "color"), colorPickerComp.hasChanges = 1, updatePicker();
    }),
